...
const MasterContainer: React.FC<MasterContainerProps> = () => {
  ...
  return (
    <Box>
      ...
      style={{ padding: '5px 0 0 0', maxWidth: '800px' }}
                        ...
                        <tbody>
                          <tr>
                            <td className="header-logo-padding" style={{ padding: '32px 32px 0' }}>
                              <DropZone
                                id="header-logo"
                                initialContent="Arrastra aquí el header logo"
                                onDrop={handleDrop}
                          ...
                          <tr>
                            <td className="mobile-padding" style={{ backgroundColor: '#0032A0', padding: '32px 72px' }}>
                              <DropZone
                                ...
                                initialContent="Arrastra aquí el header section"
                                onDrop={handleDrop}
                                setComponentName={setComponentName}
                                setComponentVariant={setComponentVariant}
                              />
                ...
                <tbody>
                  <tr>
                    <td className="mobile-padding" style={{ padding: '32px' }}>
                      <DropZone
                        id="body-section"
                        initialContent="Arrastra aquí el body section"
                        onDrop={handleDrop}
                        setComponentName={setComponentName}
                        setComponentVariant={setComponentVariant}
                        textColor='black'
                ...
                <tbody>
                  <tr>
                    <td className="mobile-padding" style={{ padding: '32px 56px', backgroundColor: '#EFEFEE', borderBottomLeftRadius: '8px', borderBottomRightRadius: '8px' }}>
                      <DropZone
                        id="footer-section"
                        initialContent="Arrastra aquí el footer section"
                        onDrop={handleDrop}
                        setComponentName={setComponentName}
                        setComponentVariant={setComponentVariant}
                        textColor="black"
