...
const PaxCards = (props: PaxCardsProps) => {
  const PaxCardCmp = (props: PaxCardsProps) => {
    let simplePaxCard, wciPaxCard = ""
    if (props.variant === "simple") {
      simplePaxCard = `<table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:100%;min-width:100%;">
                <tr>
      ...
      return simplePaxCard
    } else {
      wciPaxCard = `<div>WCI</div>`
      return wciPaxCard
    }
  }
  return PaxCardCmp(props);
}
