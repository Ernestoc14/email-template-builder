...
const InvertedInlineAlert = ({data, langProp} : {data: Component, langProp: string}) =>{
    return (
        <table border={0} cellPadding={0} cellSpacing={0} style={{ width: "100%", borderCollapse: "separate" }}>
            <tbody>
                <tr>
                    <td className="remove-styles-mso" style={{ padding: "8px 16px", backgroundColor: "#0E68FF", borderRadius: "4px"}}>
...
export default InvertedInlineAlert