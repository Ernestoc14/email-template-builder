...
const changesInlineAlertHTML = (props: AlertsProps) => {
    return `<table border="0" cellpadding="0" cellspacing="0" style=" width:100%; border-collapse: separate;">
                <tr>
                    <td style="mso-border-alt: none; padding: 8px 16px; background-color:#B15C37; border-radius: 4px">
