...
const warningContentAlertHTML = (props: AlertsProps) => {
                                        ...
                                        <tr>
                                            <![endif]-->
                                                <td style="padding-right: 8px;vertical-align:top;width:20px;max-width:20px" class="mso-padding">
                                                    <img src="https://www.copaair.com/webassets/icons/alerts/alert_incontent_warning.png"
...
export {warningContentAlertCSS, warningContentAlertHTML}