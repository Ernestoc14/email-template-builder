...
const ItineraryCardCancelled = ({data, langProp, isResponsiveView} : {data: Component, langProp: string, isResponsiveView?: boolean}) => {
...
export default ItineraryCardCancelled;