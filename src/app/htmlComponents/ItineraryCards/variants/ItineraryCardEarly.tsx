...
const ItineraryCardEarly = ({data, langProp, isResponsiveView} : {data: Component, langProp: string, isResponsiveView?: boolean}) => {
												...
												<tbody>
													<tr>
														...
														<td align="right" style={{ fontFamily: 'SuisseIntl,Helvetica, Arial, sans-serif', fontWeight: 400, fontSize: '12px', lineHeight: '16px', color: '#666666', verticalAlign: 'top' }}>
															<span style={{ whiteSpace: 'nowrap', fontFamily: 'SuisseIntl, Helvetica, sans-serif', fontSize: '12px', fontWeight: 600, padding: '2px 12px', backgroundColor: '#0E68FF', borderRadius: '12px', color: '#ffffff' }}>
																{
																	// @ts-expect-error doesn't exist itineraryCard props
																...
																<tbody>
																	<tr>
																		...
																		<td className="right-padding-mobile" style={{ whiteSpace: 'nowrap' }}>
																			<span className="remove-padding-mobile" style={{ fontSize: '20px', lineHeight: '32px', padding: '0 8px', fontWeight: 700, color: '#0E68FF' }}>
																				{
																					// @ts-expect-error doesn't exist itineraryCard props
																		...
																		<td align="right" className="left-padding-mobile" style={{ textAlign: 'right', whiteSpace: 'nowrap' }}>
																			<span className="remove-padding-mobile" style={{ fontFamily: 'Gilroy, Helvetica, Arial, sans-serif', fontSize: '20px', lineHeight: '32px', padding: '0 8px', fontWeight: 700, color: '#0E68FF' }}>
																				{
																					// @ts-expect-error doesn't exist itineraryCard props
...
export default ItineraryCardEarly;