...
const itineraryCardOnTimeHTML = (props: ItineraryCardsProps) => {
                          ...
                          <table cellpadding="0" cellspacing="0" style="width:100%;min-width:100%;">
                            <tr>
                              ...
                              <td align="right" style="font-family: SuisseIntl,Helvetica, Arial, sans-serif; font-weight: 400; font-size: 12px; line-height: 16px; color: #666666; vertical-align:top">
                                <!--[if mso]>
                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:20px;v-text-anchor:middle;width:90px;line-height: 1;" arcsize="50%" stroke="false" fillcolor="#0C7E3E">
                                    <w:anchorlock/>
...
export { itineraryCardOnTimeCSS, itineraryCardOnTimeHTML };