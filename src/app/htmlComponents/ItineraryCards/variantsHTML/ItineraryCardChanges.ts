...
const itineraryCardChangesHTML = (props: ItineraryCardsProps) => {
                          ...
                          <table cellpadding="0" cellspacing="0" style="width:100%;min-width:100%;">
                            <tr>
                              ...
                              <td align="right" style="font-family: SuisseIntl,Helvetica, Arial, sans-serif; font-weight: 400; font-size: 12px; line-height: 16px; color: #666666; vertical-align:top">
                                <!--[if mso]>
                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:20px;v-text-anchor:middle;width:90px;line-height: 1;" arcsize="50%" stroke="false" fillcolor="#B15C37">
                                    <w:anchorlock/>
                                ...
                                <table cellpadding="0" cellspacing="0" style="width:100%;min-width:100%;">
                                  <tr>
                                    <td class="right-padding-mobile"  style="white-space: nowrap;">
                                        <span class="remove-padding-mobile" style="font-family:Gilroy, Helvetica, Arial, sans-serif !important; font-size: 20px; line-height: 32px; padding: 0 8px 0 0; font-weight: 700; color:#B15C37">
                                          ${props.departureTime}
                                        </span>
                                    </td>
                                    <td style="width:48%">
                                    ...
                                    <td align="right" class="left-padding-mobile" style="text-align: right;white-space: nowrap;">
                                        <span class="remove-padding-mobile" style="font-family:Gilroy, Helvetica, Arial, sans-serif !important;font-size: 20px; line-height: 32px; padding: 0 0 0 8px; font-weight: 700; color:#B15C37">
                                          ${props?.arrivalTime}
                                        </span>
                                    </td>
                                  </tr>
                            ...
                            <tr>
                              <td colspan="2">
                                <table cellpadding="0" cellspacing="0" style="width:100%;min-width:100%;">
                                  <tr>
                                    <td style="font-family: SuisseIntl,Helvetica, Arial, sans-serif; font-size: 14px;padding-right: 12px;color: #333333;width: 50%;line-height: 20px;vertical-align: top;font-weight: 400;font-style: normal;">
                                      ${props.origin}
                                    </td>
                                    <td align="right" style="font-family: SuisseIntl,Helvetica, Arial, sans-serif; font-size: 14px;padding-left: 12px;text-align: right;color: #333333;width: 50%;line-height: 20px;vertical-align: top;font-weight: 400;font-style: normal;">
                                      ${props.destination}
                                    </td>
                                  </tr>
                                </table>
...
export { itineraryCardChangesCSS, itineraryCardChangesHTML };