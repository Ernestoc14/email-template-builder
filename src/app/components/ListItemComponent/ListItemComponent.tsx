...
export const ListItemComponent = (props: ListItemComponentProps) => {
  ...
  const noPreview = ["Markdown", "Content Section"]
  ...
  return (
    <Box>
      ...
      >
        <ListItemText slotProps={{primary:{fontFamily: "Gilroy, Arial, Helvetica, sans-serif", fontWeight: '700', fontSize: "16px"}}} primary={props.primary} />
        <IconButton
      ...
      >
        {ObjectComponents.Components[props.primary as keyof typeof ObjectComponents.Components].variants.map((variant: string, index: number) => (
          <ListItem 
            ...
            <ListItemText slotProps={{primary:{fontFamily: "SuisseIntl, Arial, Helvetica, sans-serif", fontWeight: '400', fontSize: "15px"}}} primary={variant} />
            { !noPreview.includes(variant) && (
              <IconButton
