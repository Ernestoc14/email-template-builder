...
import { ImagesTranslations } from "../htmlComponents/Images/types";
...
export interface ObjectComponentsType {
  Components: {
    ...
    Images: Component<ImagesTranslations>
  }
}
...
export const ObjectComponents: ObjectComponentsType  = {
  Components: {
    ...
    ItineraryCards: {
      variants: ["No Pill", "Early", "On Time", "Changes", "Cancelled", "Delayed", "Layover", "One Way"],
      propModal: true,
      props: {
        ES: {
          date: "Mar, 3, 2025",
    ...
    Images: {
      ...
      props: {
        ES: {
          desktopURL: "https://www.copaair.com/assets/seat-reminder-desktop-banner-7D.jpg",
          mobileURL: "https://www.copaair.com/assets/seat-reminder-mobile-banner-7D.jpg",
          altText: "Recordatorio de Asientos",
        },
        EN: {
          desktopURL: "https://www.copaair.com/assets/seat-reminder-desktop-banner-7D.jpg",
          mobileURL: "https://www.copaair.com/assets/seat-reminder-mobile-banner-7D.jpg",
          altText: "Seat Reminder",
        },
        PT: {
          desktopURL: "https://www.copaair.com/assets/seat-reminder-desktop-banner-7D.jpg",
          mobileURL: "https://www.copaair.com/assets/seat-reminder-mobile-banner-7D.jpg",
          altText: "Lembrete de Assentos",
        },
        FR: {
          desktopURL: "https://www.copaair.com/assets/seat-reminder-desktop-banner-7D.jpg",
          mobileURL: "https://www.copaair.com/assets/seat-reminder-mobile-banner-7D.jpg",
          altText: "Rappel de Sièges",
        }
      }
    }
  }
